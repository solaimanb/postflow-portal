...
export default function TopicSearchPage() {
  ...
  const handleDownloadCSV = () => {
    ...
    link.setAttribute("download", `facebook-topics-${new Date().toISOString().split("T")[0]}.csv`);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-semibold">Topic Search</h1>
        <p className="text-muted-foreground">Search and analyze Facebook topics across pages.</p>
      </div>
